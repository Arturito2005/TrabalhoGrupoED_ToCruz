package Graph.ArrayGraph.MatrizAdjacencia;

import Interfaces.Graph.Network.ExtendNetworkADT;
 ...
 * @version 1.0
 */
public class ExtendedNetwork<T> extends NetworkMatrizAdjacencia<T> implements ExtendNetworkADT<T> {
